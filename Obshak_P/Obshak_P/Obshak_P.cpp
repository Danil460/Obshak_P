...
//Командные проекты:  18 из 18
//Сергей, Матвей, Виктор - База хранения работников фирмы 
// и работа с ними с реализацией сохранений
//Виталя ,Лев, Толя - Интернет магазин, который будет сохранять все данные, в
// файл о каждом товаре
//Степа ,Владислав, Саша - Игровая платформа в котором у каждого свой 
//  аккаунт с балансом
//Никита,Владислав, Равиль - управление запасом магазина, 
//  сохранение информациии в файле о кол-во оставщихся товаров
//Дмитрий, Алексей, Владислав - переработка текстового рпг квеста
//Максим ,Миша ,Лукьян - разработать игру виселица